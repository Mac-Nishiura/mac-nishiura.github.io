...
var changeEnglish = function (num) {
  var p = document.createElement('p');
  p.innerHTML = english_adjectives[num]; 
  h6[0].after(p);
}
var changeJapanese = function (num) {
...
question.addEventListener('click', changeEnglish(random));
answer.addEventListner('click', changeJapanese(random));
erase.addEventListener('click', removeText);

h6[0].addEventListener('click', changeEnglish(i));
